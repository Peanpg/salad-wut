...
export default function App() {
  ...
  const [editTab, setEditTab] = useState('current');
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in fade-in duration-200">
              ...
              <form onSubmit={handleSaveDailyLog} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border-2 border-slate-200 p-3 font-mono font-bold text-base sm:text-lg focus:outline-none focus:border-emerald-500"
                    />
                    <span className="text-xs text-rose-505 font-bold">ระวัง: อุณหภูมิพืชสลัด &gt; 28°C</span>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border-2 border-slate-200 p-3 font-mono font-bold text-base sm:text-lg focus:outline-none focus:border-emerald-500"
                    />
                    <span className="text-xs text-slate-505 block font-semibold">
                ...
                <div className="p-1 bg-amber-50/70 border border-amber-200 rounded-2xl">
                  <button
                    ...
                    className="w-full flex justify-between items-center px-4 py-3 text-amber-955 font-bold text-xs sm:text-sm hover:bg-amber-100/50 rounded-xl transition-all"
                  >
                  ...
                  {showChemicalAdditions && (
                    <div className="p-4 pt-1 grid grid-cols-2 gap-3 bg-white rounded-xl border border-amber-100 m-1.5 text-xs animate-in slide-in-from-top duration-150">
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-rose-850">เติม pH DOWN (มล.)</label>
                        <input
                          type="number"
                          value={addedPhDown}
                      ...
                      <div className="space-y-1">
                        <label className="font-bold text-emerald-850">เติม pH UP (มล.)</label>
                        <input
                          type="number"
                          value={addedPhUp}
                      ...
                      <div className="col-span-2 border-t pt-2 mt-2">
                        <p className="font-extrabold text-amber-955 mb-1">🔍 บันทึกค่าวัดสารละลายที่เปลี่ยนไปหลังเติม:</p>
                      </div>

                      <div className="space-y-1">
                        <label className="font-bold text-indigo-950">ค่า pH ใหม่หลังเติม</label>
                        <input
                          type="number"
                          step="0.1"
            ...
            <div className="bg-amber-50 p-5 sm:p-7 rounded-3xl border border-amber-200 lg:col-span-12 space-y-4">
              ...
              <div className="bg-white p-4 rounded-2xl border border-amber-100 space-y-2 text-xs sm:text-sm">
                <p className="font-bold text-emerald-955">📐 อัตราปุ๋ยมาตรฐานตามประเภทราง:</p>
                    ...
                    <div className="p-4 border-t border-slate-100 bg-slate-50 space-y-2">
                      ...
                      <div className="flex gap-2 justify-between">
                        <button
                          ...
                          className="bg-sky-50 hover:bg-sky-100 border border-sky-300 text-sky-850 font-bold text-xs px-3 py-1.5 rounded-lg transition-all"
                        >
                          ✏️ แก้ไขข้อมูล
                        </button>
                        <button
                          onClick={() => handleDeleteLot(lot.id)}
                          className="bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-750 font-bold text-xs px-3 py-1.5 rounded-lg transition-all"
                        >
                          🗑️ ลบล็อตนี้
                        </button>
                      </div>
                      ...
                      {stageData.map((stage) => (
                        <div key={stage.key} className="flex items-center justify-between gap-4">
                          <div className="flex items-center space-x-1.5 min-w-0">
                            ...
                            <span className="font-semibold text-slate-600 truncate">{stage.name}:</span>
                          </div>
                          ...
                          <td className="py-4 px-5">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                              {lot.vegetables?.map((veg, i) => {
                                ...
                                return (
                                  <span key={i} className="bg-slate-100 text-slate-700 rounded px-1.5 py-0.2 text-[11px] font-bold">
                  ...
                  {filteredGuides.map((guide) => (
                    <div key={guide.id} className="bg-white p-5 rounded-2xl border border-slate-200 space-y-2 border-l-4 border-l-rose-500">
                      ...
                      <div className="bg-rose-50/50 p-2.5 rounded-xl border text-xs space-y-1">
                        ...
                        <p className="font-bold text-emerald-950 mt-1">🧪 วิธีแก้ไข & การบำรุงรักษา:</p>
                        <p className="text-slate-600 font-medium">{guide.treatment}</p>
                      </div>
                    </div>
                  ))}
                  ...
                  <div className="divide-y divide-slate-200">
                    {viewedGuideHistory.map((hist, i) => (
                      <div
                        ...
                        className="py-2 flex justify-between items-center text-xs text-slate-650 font-medium hover:text-emerald-700 hover:bg-white px-2 rounded-lg cursor-pointer transition-all"
                      >
